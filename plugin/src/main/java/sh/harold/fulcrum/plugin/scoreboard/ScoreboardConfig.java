...
public record ScoreboardConfig(String title, String headerPattern, String headerDateFormat, String bottomLine) {
    ...
    static final FeatureConfigOption<String> BOTTOM_LINE_OPTION = FeatureConfigOptions.stringOption("bottom_line", "&7#feedback-and-suggestions");
    ...
    static ScoreboardConfig from(FeatureConfiguration configuration) {
        return new ScoreboardConfig(
            ...
            configuration.value(BOTTOM_LINE_OPTION)
        );
    }
}
